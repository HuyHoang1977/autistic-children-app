      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-600 text-sm">
              Nền tảng chia sẻ kiến thức y tế kết nối phụ huynh và bác sĩ tình nguyện.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li className="text-gray-600">Email: contact@healthcare.com</li>
              <li className="text-gray-600">Điện thoại: +84 123 456 789</li>
              <li className="text-gray-600">Địa chỉ: 123 Đường ABC, Quận 1, TP.HCM</li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-600">
            © {new Date().getFullYear()} Healthcare Platform. Tất cả quyền được bảo lưu.
          </p>
